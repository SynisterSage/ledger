import type { EditorNativeEvent, NativeEditorCommand } from '@ledger/mobile-editor-bridge/messages';

// Keep the runtime validator inside the Expo app bundle. Metro can consume the
// shared protocol types, but archive bundling must not depend on resolving the
// external package's implementation file outside the mobile project root.
const MAX_DOCUMENT_HTML_LENGTH = 2_000_000;
