...
export type PluginTarget = { id: string; type: 'task' | 'project' | 'note' | 'meetingNote' | 'intake'; title: string; subtitle?: string; status?: string; url?: string; open_url?: string };
...
export type PluginTaskCreateOptions = { assignees: PluginEditOption[]; projects: PluginEditOption[] };
export type LinkedWorkSummary = { id: string; type: 'task' | 'project' | 'note' | 'meetingNote' | 'intake'; title: string; status?: string; assignee?: { id: string; name: string; avatarUrl?: string }; projectId?: string; projectName?: string; dueDate?: string; priority?: string; ledgerUrl: string; openUrl?: string; relationshipId: string; relationshipSources: string[]; updatedAt?: string | null; canUnlink?: boolean; editCapabilities?: EditCapabilities };
