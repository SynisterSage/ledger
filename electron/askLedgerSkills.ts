...
const registry: AskLedgerSkillDefinition[] = [
  ...
  },
  {
    ...
    icon: 'FolderKanban',
    instructions: 'Assess the selected project using its status, related tasks, blockers, overdue or stale work, and recent notes or meetings when supplied. Keep the assessment concise and evidence-based. A low progress value is not itself a problem. Do not propose mutations.',
  ...
  },
  {
    id: 'plan_my_week',
    name: 'Plan my week',
    description: 'Build a concise, grounded plan from current work, deadlines, and calendar context.',
    icon: 'CalendarDays',
    instructions: 'Review active projects, relevant tasks, deadlines, reminders, calendar context, and recent work. Return a prioritized but concise plan based only on evidence in Ledger. Do not invent priorities, deadlines, or available time.',
