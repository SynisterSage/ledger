...
contextBridge.exposeInMainWorld('askLedger', {
  ...
  generateProjectLens(payload: unknown) { return ipcRenderer.invoke('project-lens:generate', payload) as Promise<unknown>; },
  generateProjectLensAction(payload: unknown) { return ipcRenderer.invoke('project-lens:action', payload) as Promise<unknown>; },
  generateMeetingRecap(payload: unknown) { return ipcRenderer.invoke('meeting-recap:generate', payload) as Promise<unknown>; },
  generateMeetingPeople(payload: unknown) { return ipcRenderer.invoke('meeting-people:suggest', payload) as Promise<unknown>; },
  generateMeetingPrep(payload: unknown) { return ipcRenderer.invoke('meeting-prep:generate', payload) as Promise<unknown>; },
