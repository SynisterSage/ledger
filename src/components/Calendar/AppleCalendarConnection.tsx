...
export const AppleCalendarConnection = ({ userId, onManageCalendar, onManageReminders }: Props) => {
  ...
  return <div>
    ...
    <div className="px-4 py-2.5">
      ...
      {permissionIssue && <LedgerEmptyState state="permission" title="Apple Calendar access is off" description="Allow calendar access in macOS System Settings to reconnect Ledger." size="compact" testId="apple-calendar-permission" primaryAction={{ label: 'Open System Settings', onClick: () => void window.appleCalendar?.openSystemSettings() }} className="px-0 py-2" />}
    ...
    <div className="px-4 py-2.5">
      ...
      {reminderPermissionIssue && <LedgerEmptyState state="permission" title="Apple Reminders access is off" description="Allow reminders access in macOS System Settings to reconnect Ledger." size="compact" testId="apple-reminders-permission" primaryAction={{ label: 'Open System Settings', onClick: () => void window.appleReminders?.openSystemSettings() }} className="px-0 py-2" />}
