...
export const GithubIntegrationPage = ({ workspaceId, canManage, onBack, onStatusChange }: Props) => {
  ...
  return <section className="w-full max-w-215" aria-labelledby="settings-github">
    <IntegrationPageHeader id="settings-github" title="GitHub" description="Connect repositories, capture development activity, and keep GitHub work moving through Ledger." icon={<IntegrationProviderMark provider="github" size={30} />} onBack={onBack} />
    ...
    {confirmDisconnect && (
      <IntegrationConfirmModal
        ...
        body="This removes the workspace connection and approved repository metadata. It does not uninstall the GitHub App."
