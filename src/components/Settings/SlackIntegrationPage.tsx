...
export const SlackIntegrationPage = ({ workspaceId, canManage, onBack, onStatusChange }: Props) => {
  ...
  return <section className="w-full max-w-215" aria-labelledby="settings-slack">
    <IntegrationPageHeader id="settings-slack" title="Slack" description="Capture Slack messages, monitor selected conversations, and link Slack context throughout Ledger." icon={<IntegrationProviderMark provider="slack" size={30} />} onBack={onBack} />
