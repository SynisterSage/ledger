  ...
  const openGoogleDrivePicker = async () => {
    ...
    try {
      ...
      await new Promise<void>((resolve) => {
        ...
        const pickerBuilder = new googleWindow.google.picker.PickerBuilder().addView(docsView).enableFeature(googleWindow.google.picker.Feature.MULTISELECT_ENABLED).setOAuthToken(tokenResult.access_token);
