    ...
    <>
      ...
      {open && (
        <ModalOverlay
          ...
          classNameContainer="flex max-h-[calc(100vh-32px)] w-full max-w-lg flex-col overflow-hidden rounded-[var(--ledger-surface-radius)] border border-[color:var(--ledger-border-subtle)] bg-[var(--ledger-surface-card)] shadow-[var(--ledger-shadow)]"
        >
