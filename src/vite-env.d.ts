...
interface Window {
  ...
  askLedger?: {
    ...
    setAIProviderKey: (payload: { provider: 'openai' | 'anthropic' | 'google' | 'perplexity' | 'kimi'; apiKey: string }) => Promise<unknown>;
    removeAIProviderKey: (provider: 'openai' | 'anthropic' | 'google' | 'perplexity' | 'kimi') => Promise<unknown>;
    testAIProvider: (provider: 'openai' | 'anthropic' | 'google' | 'perplexity' | 'kimi') => Promise<unknown>;
    listAIProviderModels: (provider: 'openai' | 'anthropic' | 'google' | 'perplexity' | 'kimi') => Promise<unknown>;
    getSelectedAIProviderModel: (provider: 'openai' | 'anthropic' | 'google' | 'perplexity' | 'kimi') => Promise<string>;
    setSelectedAIProviderModel: (payload: { provider: 'openai' | 'anthropic' | 'google' | 'perplexity' | 'kimi'; model: string }) => Promise<unknown>;
    getSelectedAIProvider: () => Promise<'local' | 'openai' | 'anthropic' | 'google' | 'perplexity' | 'kimi'>;
    getAIProviderCloudConsent: () => Promise<boolean>;
    setAIProviderCloudConsent: (enabled: boolean) => Promise<boolean>;
    setSelectedAIProvider: (provider: 'local' | 'openai' | 'anthropic' | 'google' | 'perplexity' | 'kimi') => Promise<unknown>;
    onAIProviderState?: (listener: (state: { provider: 'local' | 'openai' | 'anthropic' | 'google' | 'perplexity' | 'kimi'; cloudConsent: boolean; model: string | null }) => void) => () => void;
