...
interface Window {
  ...
  localContext?: {
    ...
    updateFolderColor: (payload: { ownerUserId: string; workspaceId: string; folderId: string; color: string }) => Promise<import('./types/localContextLibrary').LocalContextFolder>;
  ...
  askLedger?: {
    ...
    setAIProviderKey: (payload: { provider: 'openai' | 'anthropic' | 'google' | 'perplexity' | 'kimi' | 'deepseek'; apiKey: string }) => Promise<unknown>;
    removeAIProviderKey: (provider: 'openai' | 'anthropic' | 'google' | 'perplexity' | 'kimi' | 'deepseek') => Promise<unknown>;
    testAIProvider: (provider: 'openai' | 'anthropic' | 'google' | 'perplexity' | 'kimi' | 'deepseek') => Promise<unknown>;
    listAIProviderModels: (provider: 'openai' | 'anthropic' | 'google' | 'perplexity' | 'kimi' | 'deepseek') => Promise<unknown>;
    getSelectedAIProviderModel: (provider: 'openai' | 'anthropic' | 'google' | 'perplexity' | 'kimi' | 'deepseek') => Promise<string>;
    setSelectedAIProviderModel: (payload: { provider: 'openai' | 'anthropic' | 'google' | 'perplexity' | 'kimi' | 'deepseek'; model: string }) => Promise<unknown>;
    getSelectedAIProvider: () => Promise<'local' | 'openai' | 'anthropic' | 'google' | 'perplexity' | 'kimi' | 'deepseek'>;
    getAIProviderCloudConsent: () => Promise<boolean>;
    setAIProviderCloudConsent: (enabled: boolean) => Promise<boolean>;
    setSelectedAIProvider: (provider: 'local' | 'openai' | 'anthropic' | 'google' | 'perplexity' | 'kimi' | 'deepseek') => Promise<unknown>;
    onAIProviderState?: (listener: (state: { provider: 'local' | 'openai' | 'anthropic' | 'google' | 'perplexity' | 'kimi' | 'deepseek'; cloudConsent: boolean; model: string | null }) => void) => () => void;
